...
Suresh is developing a simple student information system where users can input the name and roll number of a student, and 
the program will display the student's information. The program provided can be used to achieve this functionality.

Help him to write a program that takes user input for a name and a roll number and then displays the input in the 
following format: "<number>: <name>". The program should define a class called Input with two member variables: a string variable 
called "name" and an integer variable called "rollnum".
